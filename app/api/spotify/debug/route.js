...
export async function GET() {
  return NextResponse.json({
    buildVersion: 'closed-page-text-size-2026-05-17-v16',
    ...
    note: 'v16: Sperrseiten-Text angepasst: DJ-Hinweis kleiner, ausgewählte Sperr-Nachricht groß und auffällig. Dashboard, Spotify und Gäste-Seite bleiben erhalten.'
  });
}
